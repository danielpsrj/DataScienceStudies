...
class TestExperimentRepository:
    ...
    def test_update_experiment_metrics(self, test_db, sample_experiment_data, sample_user_data):
...
class TestDatasetRepository:
    ...
    def test_get_dataset_by_name(self, test_db, sample_dataset_data):
        ...
        retrieved_dataset = dataset_repo.get_dataset_by_name(sample_dataset_data["name"])
...
class TestConceptRepository:
    ...
    def test_get_concept_by_name(self, test_db, sample_concept_data):
        ...
        retrieved_concept = concept_repo.get_concept_by_name(sample_concept_data["name"])
...
class TestAlgorithmRepository:
    ...
    def test_create_algorithm(self, test_db, sample_algorithm_data, sample_concept_data):
        ...
        assert algorithm.implementation_libraries == sample_algorithm_data["implementation_libraries"]
    ...
    def test_get_algorithm_by_name(self, test_db, sample_algorithm_data, sample_concept_data):
        ...
        retrieved_algorithm = algo_repo.get_algorithm_by_name(sample_algorithm_data["name"])
...
class TestDatabaseIntegration:
    ...
    def test_user_experiment_relationship(self, test_db, sample_user_data, sample_experiment_data):
    ...
    def test_concept_algorithm_relationship(self, test_db, sample_concept_data, sample_algorithm_data):
