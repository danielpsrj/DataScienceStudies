...
def create_concepts_and_algorithms() -> Dict[str, int]:
    ...
    with ConceptRepository() as concept_repo, AlgorithmRepository() as algo_repo:
        ...
        regression = concept_repo.create_concept(
            ...
            common_algorithms=["linear_regression", "ridge_regression", "lasso_regression", "polynomial_regression"],
            use_cases=["price prediction", "demand forecasting", "risk assessment", "trend analysis"],
        ...
        algo_repo.create_algorithm(
            ...
            parameters={
                "fit_intercept": {"type": "bool", "default": True, "description": "Whether to calculate the intercept"},
                "normalize": {"type": "bool", "default": False, "description": "Whether to normalize features"},
            },
            strengths=["Simple to implement", "Interpretable coefficients", "Fast training"],
        ...
        algo_repo.create_algorithm(
            ...
            parameters={
                "alpha": {"type": "float", "default": 1.0, "description": "Regularization strength"},
                "solver": {"type": "str", "default": "auto", "description": "Solver to use"},
            },
            strengths=["Reduces overfitting", "Handles multicollinearity", "Stable solutions"],
            weaknesses=["All coefficients remain non-zero", "Requires hyperparameter tuning"],
        ...
        clustering = concept_repo.create_concept(
            ...
            use_cases=["customer segmentation", "anomaly detection", "image segmentation", "document clustering"],
        ...
        algo_repo.create_algorithm(
            ...
            mathematical_formulation="argmin_S Σᵢ=1ᵏ Σ_{x∈Sᵢ} ||x - μᵢ||²",
            parameters={
                "n_clusters": {"type": "int", "default": 8, "description": "Number of clusters"},
                "max_iter": {"type": "int", "default": 300, "description": "Maximum iterations"},
                "random_state": {"type": "int", "default": None, "description": "Random seed"},
            },
            strengths=["Simple and fast", "Scales well", "Easy to interpret"],
            weaknesses=["Requires specifying k", "Sensitive to initialization", "Assumes spherical clusters"],
        ...
        algo_repo.create_algorithm(
            ...
            parameters={
                "eps": {"type": "float", "default": 0.5, "description": "Maximum distance between points"},
                "min_samples": {"type": "int", "default": 5, "description": "Minimum samples in neighborhood"},
            },
            strengths=["No need to specify k", "Handles noise", "Finds arbitrary shapes"],
            weaknesses=["Sensitive to parameters", "Struggles with varying densities", "High-dimensional data"],
        ...
        classification = concept_repo.create_concept(
            ...
            common_algorithms=["logistic_regression", "decision_tree", "random_forest", "svm"],
            use_cases=["spam detection", "image recognition", "fraud detection", "medical diagnosis"],
        ...
        time_series = concept_repo.create_concept(
            ...
            use_cases=["stock prediction", "weather forecasting", "sales forecasting", "energy demand"],
...
def create_sample_experiments(user_ids: Dict[str, int], concept_ids: Dict[str, int]) -> None:
