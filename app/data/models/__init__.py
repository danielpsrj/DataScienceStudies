...
class User(Base):
    ...
    saved_models: Mapped[List["SavedModel"]] = relationship(
        "SavedModel", back_populates="user", cascade="all, delete-orphan"
    )
...
class Experiment(Base):
    ...
    visualizations: Mapped[List["Visualization"]] = relationship(
        "Visualization", back_populates="experiment", cascade="all, delete-orphan"
    )
...
class Visualization(Base):
    ...
    experiment: Mapped["Experiment"] = relationship(
        "Experiment", back_populates="visualizations"
    )
...
class Algorithm(Base):
    ...
    implementation_libraries: Mapped[List[str]] = mapped_column(
        JSON, default=list
